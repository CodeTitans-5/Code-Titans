...
public class ChangePasswordTest {
    @Rule
    public ActivityTestRule<ChangePasswordActivity> rule  = new  ActivityTestRule<ChangePasswordActivity>(ChangePasswordActivity.class){
        @Override
        protected Intent getActivityIntent() {
            InstrumentationRegistry.getInstrumentation().getTargetContext();
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.putExtra("oldPassword", "123456");
    ...
    @Test
    public void ensurePwdDataIsCorrect() throws Exception {
        ChangePasswordActivity activity = rule.getActivity();
